...
<ul class="nav nav-tabs" role="tablist">
	<li role="presentation" class="active"><a href="#existingClient" aria-controls="existingClient" role="tab" data-toggle="tab">Client</a></li>
	<li role="presentation"><a href="#newClient" aria-controls="newClient" role="tab" data-toggle="tab">New Client</a></li>
</ul>

<div class="tab-content">
	<div role="tabpanel" class="tab-pane active" id="existingClient">
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-body">
								...
								<input type="hidden" id="sessionId" name="sessionId" value="<?php echo $s['sid'];?>">
	...
	<div role="tabpanel" class="tab-pane" id="newClient">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="col-md-3">
					<input id="firstname" name="firstname" type="text" value="" class="form-control input-md">
				</div>
				<label class="col-md-2 control-label" for="lastname">Last Name</label>
				<div class="col-md-3">
					<input id="lastname" name="lastname" type="text" value=""  class="form-control input-md">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-3">
					<input name="phone" id="phone" type="text" value="" class="input-medium bfh-phone form-control" data-format="+ddd dd ddddddd">
				</div>
